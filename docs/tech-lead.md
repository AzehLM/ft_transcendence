...
- `MINIO_SERVER_URL` **env variable**: only affects URLs generated internally by MinIO, not those generated bu the Go SDK client.
...
> ⚠️ These fixes works in development mode; production viability is still uncertain
